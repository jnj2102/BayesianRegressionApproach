...
fullTable <- read.csv(file = 'CholeskyDecomp_Boxplot_Loss_p25_n25.csv', header = TRUE, sep = ',')
...
fullTable_p50 <- read.csv(file = 'CholeskyDecomp_Boxplot_Loss_p50_n100.csv', header = TRUE, sep = ',')
...
fullTable_p100 <- read.csv(file = 'CholeskyDecomp_Boxplot_Loss_p100_n300.csv', header = TRUE, sep = ',')
...
save(fullTable, file = 'CholeskyDecomp_Boxplot_Loss_table.rdata')
