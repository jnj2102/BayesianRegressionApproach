...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n25, p25, sparsity = AR2
...
%save('PaperCholeskyDecomp_Sigma_true_p25_n25_AR2_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p25_n25_AR2_xmat.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n25_p25_AR2 = cell([reps,1]);
    minK_n25_p25_AR2 = cell([reps,1]);
    Final_AIC_n25_p25_AR2 = cell([reps,1]);
...
N_points);
    ...
    optimalJ_n25_p25_AR2{iters} = optimalJ;
    minK_n25_p25_AR2{iters} = minK;
    Final_AIC_n25_p25_AR2{iters} = Final_AIC;
...
save('CholeskyDecomp_p25_n25_AR2_prior_FFN.mat');
