...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n300, p100, sparsity = circle
...
%save('PaperCholeskyDecomp_Sigma_true_p100_n300_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p100_n300_circle_xmat.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n300_p100_circle = cell([reps,1]);
    minK_n300_p100_circle = cell([reps,1]);
    Final_AIC_n300_p100_circle = cell([reps,1]);
...
N_points);
    ...
    optimalJ_n300_p100_circle{iters} = optimalJ;
    minK_n300_p100_circle{iters} = minK;
    Final_AIC_n300_p100_circle{iters} = Final_AIC;
...
save('CholeskyDecomp_p100_n300_circle_prior_FFN.mat');
