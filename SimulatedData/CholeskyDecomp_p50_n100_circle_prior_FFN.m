...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n100, p50, sparsity = circle
...
%save('PaperCholeskyDecomp_Sigma_true_p50_n100_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p50_n100_circle_xmat.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n100_p50_circle = cell([reps,1]);
    minK_n100_p50_circle = cell([reps,1]);
    Final_AIC_n100_p50_circle = cell([reps,1]);
...
N_points);
    ...
    optimalJ_n100_p50_circle{iters} = optimalJ;
    minK_n100_p50_circle{iters} = minK;
    Final_AIC_n100_p50_circle{iters} = Final_AIC;
...
save('CholeskyDecomp_p50_n100_circle_prior_FFN.mat');
