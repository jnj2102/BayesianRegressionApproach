...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n25, p25, sparsity = circle
...
%save('PaperCholeskyDecomp_Sigma_true_p25_n25_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p25_n25_circle_xmat.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n25_p25_circle = cell([reps,1]);
    minK_n25_p25_circle = cell([reps,1]);
    Final_AIC_n25_p25_circle = cell([reps,1]);
...
N_points);
    ...
    optimalJ_n25_p25_circle{iters} = optimalJ;
    minK_n25_p25_circle{iters} = minK;
    Final_AIC_n25_p25_circle{iters} = Final_AIC;
...
save('CholeskyDecomp_p25_n25_circle_prior_FFN.mat');
