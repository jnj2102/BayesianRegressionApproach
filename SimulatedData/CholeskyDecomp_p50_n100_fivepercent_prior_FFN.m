...
%save('PaperCholeskyDecomp_Sigma_true_p50_n100_fivepercent_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p50_n100_fivepercent_xmat.mat','omega_true');
...
save('CholeskyDecomp_p50_n100_fivepercent_prior_FFN.mat');
