...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n100, p50, sparsity = AR2
...
%save('PaperCholeskyDecomp_Sigma_true_p50_n100_AR2_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p50_n100_AR2_xmat.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n100_p50_AR2 = cell([reps,1]);
    minK_n100_p50_AR2 = cell([reps,1]);
    Final_AIC_n100_p50_AR2 = cell([reps,1]);
...
N_points);
    ...
    optimalJ_n100_p50_AR2{iters} = optimalJ;
    minK_n100_p50_AR2{iters} = minK;
    Final_AIC_n100_p50_AR2{iters} = Final_AIC;
...
save('CholeskyDecomp_p50_n100_AR2_prior_FFN.mat');
