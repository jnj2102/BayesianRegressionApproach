...
parfor (iters = 1:reps) 
   ...
   fprintf('Iterations = %d', iters);
    ...
    mean_Z_Bayes_est, edge_matrix_estimate] = NoTransform_CholeskyDecomp_VariationalBayes_plugIn_mem(n,p,...
       x_matrix_n300_p100{iters}, omega_true, sigma_true, capital_A,capital_B,  tau, zeta_squared,num_VB_samples);
...
save('CholeskyDecomp_p100_n300_twopercent_VB_notransform.mat', '-v7.3');
