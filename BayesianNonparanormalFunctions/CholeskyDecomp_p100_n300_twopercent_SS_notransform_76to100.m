...
entropy_loss_n300_p100_twopercent(iters) = entropy_loss; 
   ...
   Frobenius_norm_covariance_n300_p100_twopercent(iters) = Frobenius_norm_covariance; 


    edge_matrix_n300_p100_twopercent{ iters} = edge_matrix_estimate;

   Omega_Bayes_est_n300_p100_twopercent{ iters} = Omega_Bayes_est;
    Sigma_Bayes_est_n300_p100_twopercent{ iters} = Sigma_Bayes_est;
...
save('CholeskyDecomp_p100_n300_twopercent_SS_notransform_76to100.mat', '-v7.3');
