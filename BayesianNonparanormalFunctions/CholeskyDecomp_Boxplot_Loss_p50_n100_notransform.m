...
load(sprintf('CholeskyDecomp_p50_n100_AR2_SS_notransform_%dto%d.mat', ssIters, ssIters2));

entropy_loss_n100_p50_AR2 = entropy_loss_n100_p50_AR2(:,:,ssIters:ssIters2);
bounded_loss_n100_p50_AR2 = bounded_loss_n100_p50_AR2(:,:,ssIters:ssIters2);
Frobenius_norm_precision_n100_p50_AR2 = Frobenius_norm_precision_n100_p50_AR2(:,:,ssIters:ssIters2);
...
load('CholeskyDecomp_p50_n100_AR2_VB_notransform.mat');
...
load('CholeskyDecomp_p50_n100_AR2_HS_notransform_final.mat');
...
load(sprintf('CholeskyDecomp_p50_n100_fivepercent_SS_notransform_%dto%d.mat', ssIters, ssIters2));

entropy_loss_n100_p50_fivepercent = entropy_loss_n100_p50_fivepercent(:,:,ssIters:ssIters2);
bounded_loss_n100_p50_fivepercent = bounded_loss_n100_p50_fivepercent(:,:,ssIters:ssIters2);
Frobenius_norm_precision_n100_p50_fivepercent = Frobenius_norm_precision_n100_p50_fivepercent(:,:,ssIters:ssIters2);
...
load('CholeskyDecomp_p50_n100_fivepercent_VB_notransform.mat');
...
load('CholeskyDecomp_p50_n100_fivepercent_HS_notransform_final.mat');
...
load(sprintf('CholeskyDecomp_p50_n100_circle_SS_notransform_%dto%d.mat', ssIters, ssIters2));

entropy_loss_n100_p50_circle = entropy_loss_n100_p50_circle(:,:,ssIters:ssIters2);
bounded_loss_n100_p50_circle = bounded_loss_n100_p50_circle(:,:,ssIters:ssIters2);
Frobenius_norm_precision_n100_p50_circle = Frobenius_norm_precision_n100_p50_circle(:,:,ssIters:ssIters2);
...
load('CholeskyDecomp_p50_n100_circle_VB_notransform.mat');
...
load('CholeskyDecomp_p50_n100_circle_HS_notransform_final.mat');
...
writetable(combine_tables,'CholeskyDecomp_Boxplot_Loss_p50_n100_notransform.csv') 
