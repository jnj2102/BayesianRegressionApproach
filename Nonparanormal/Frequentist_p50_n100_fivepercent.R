...
data <- readMat('CholeskyDecomp_p50_n100_fivepercent_prior_FFN.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p50_n100_fivepercent.rdata")
