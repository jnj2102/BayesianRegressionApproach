...
###########Simulation combination: n=100, p=50, sparsity = circle#######
result_list <- list()

lambda <- seq(from = 0.16, to = 1.2, length.out = 50) #in the Liu et al 2009 paper

data <- readMat('CholeskyDecomp_p50_n100_circle_prior_FFN.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p50_n100_circle.rdata")
