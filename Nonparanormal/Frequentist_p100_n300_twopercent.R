...
data <- readMat('CholeskyDecomp_p100_n300_twopercent_prior_FFN.mat', package = "R.matlab") #Read in all the data
...
#Run this in a loop for each iteration 
  ...
  xmat <- data$x.matrix.n300.p100[[iters]][[1]]
...
save.image(file = "Frequentist_p100_n300_twopercent.rdata")
