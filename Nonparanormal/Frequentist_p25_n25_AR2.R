...
###########Simulation combination: n=25, p=25, sparsity = AR2#######
result_list <- list()

lambda <- seq(from = 0.16, to = 1.2, length.out = 50) #in the Liu et al 2009 paper

data <- readMat('CholeskyDecomp_p25_n25_AR2_prior_FFN.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p25_n25_AR2.rdata")
