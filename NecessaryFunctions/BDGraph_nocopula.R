...
BDGraph_nocopula <- function(omega_true, sigma_true, xmat,p) {
...
bdgraph.obj <- bdgraph(xmat, method = "ggm", iter = 15000, burnin = 5000, multi.update = 1,
                       save.all = FALSE) #Gaussian graphical models (no transformation via copula)
